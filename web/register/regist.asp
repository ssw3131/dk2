        ...
        <form name='frmFORM' method='post'>
          ...
          <div class="regist">
            ...
            <div class="agree_radio">
              <input type="radio" class="type-radio" name="hAGREE1" value="Y" id="all_agree"> <label for="all_agree" style="margin-right:35px;">위 항목에 모두 동의합니다.</label>
              ...
              <table summary="관심고객등록 게시물">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><input type="text" name="hNAME" maxlength="5" class="type-text" style="width:150px;" /></td>
                  </tr>
                  <tr>
                    <th><span class="necessary">*</span> 핸드폰</th>
                    <td>
                      <select name="hPCS1" id="select" onchange="javascript:fSetConfirm();" style="width:68px;">
										...
										</select> - <input name="hPCS2" type="text" class="type_text" maxlength="4" style="ime-mode:disabled; width: 68px;" onkeypress="javascript:GetKey();fSetConfirm();"> - <input name="hPCS3" type="text" class="type_text" maxlength="4"
                        style="ime-mode:disabled; width: 68px;" onkeypress="javascript:GetKey();fSetConfirm();">
                    </td>
                  </tr>
                  <tr>
                    <th>이메일</th>
                    <td>
                      <input type="text" class="type-text" name="hEMAIL" id="IEmail" style="width:180px;" /> @
                      <input type="text" class="type-text" name="EmailTail" style="width:200px;" />
                      <select name="EmailTail2" title="메일 끝자리 직접선택" id="select4" onchange='EmailMethod();' style="width:160px;height:37px;">
                  ...
                  <tr>
                    ...
                    <td>
                      <input name="hZIP" id="userZip1" type="text" class="type-text" style="width:80px;vertical-align:top;" maxlength="3" readonly onClick="javascript:zipSearch();" />
                      <a href="javascript:zipSearch();" onFocus="this.blur();" class="btn_zip">우편번호검색</a></p>
                      <div class="add_more" style="margin-top:3px;">
                        <input name="hADDR1" id="userZip2" type="text" class="type-text" readonly style="width:564px;margin-bottom:3px;display:block;" />
                        <input name="hADDR4" id="userZip3" type="text" class="type-text" style="width:564px;" />
                      </div>
            ...
            <!-- <div class="content_foot">
              <ul>
                <li>※ <span class="necessary">*</span> 표시가 되어있는 항목을 필수입력 사항입니다.</li>
                <li>※ 상기 본인은 기재한 전화번호, 이메일, 주소로 향후 홍보 및 사이트 발송을 동의합니다.</li>
                <li>※ 관심고객으로 등록된 고객님의 정보는 분양정보를 안내하는데 사용합니다.</li>
                <li>※ 고객님의 소중한 정보는 분양 이외의 목적으로 사용되지 않습니다.</li>
              </ul>
            </div> -->

            <div class="button">
              <a href="#" class="btn_regist" onClick="javascript:fGoSave(); return false;">등록</a>
