				...
				<div class="content">
					<form name='frmFORM' method='post'>
						...
						<div class="board">
							...
							<table class="board_table" summary="공지사항 테이블 입니다.">
								<caption>
									공지사항 리스트
								</caption>
								<colgroup>
...
%>
										<tr>
											...
											<td class="sbj">
												<a href="javascript:fGoView(<%=arrDOC_ID%>);" target="_self">
													<%=arrSUBJECT%>
												</a>
											</td>
											<td class="press">관리자</td>
											<td class="date">
...
<%
	...
	sPaging = makePaging( _
		linkPage, linkParams, paramName, 5, nowPageStyle, Null, iPage, totalPage, arrIconDir, "Lct" , False _
	)
%>
									<%=sPaging%>
										<!-- <a href="#" class="prev">&lt;</a>
